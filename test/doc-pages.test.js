...
test('every public doc page is routed, rendered, and linked from the footer', () => {
  for (const [view, path] of [['about', '/about'], ['extension', '/extension'], ['audit', '/audit'], ['rights', '/rights'], ['terms', '/terms']]) {
  ...
  for (const label of ['About', 'Extension', 'Brief audit', 'Rights &amp; claims', 'Terms', 'privacy.html']) {
