...
- [ ] CORS, secure headers, request limits, URL and DNS-answer SSRF defenses, bounded request telemetry, health/readiness, migrations, backups, and recovery are documented and tested.
