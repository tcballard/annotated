...
4. Start the container and require `/api/ready` to return 200 before routing traffic; readiness now performs a database health query and an S3-compatible bucket check.
