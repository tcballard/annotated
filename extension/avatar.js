// GENERATED from packages/core/src/avatar.ts by scripts/build-core.mjs — do
...
export const avatarInitial = (person = {}) => String(person.displayName || person.handle || 'A').trim().slice(0, 1).toUpperCase() || 'A';
